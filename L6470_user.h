...
//[L6470 DEBUG]:  Caution DEC is rounded to 200790 [x0.01 step/s^2]
    {{	0x06,	{0x00,	0x8a,	0x00}}},
//[L6470 DEBUG]:  Caution MAX_SPEED is rounded to 99125 [x0.01 step/s]
    {{	0x07,	{0x00,	0x41,	0x00}}},
    {{	0x08,	{0x00,	0x00,	0x00}}},
...
//[L6470 DEBUG]:  Caution percentage is round to 1607[0.01%]
    {{	0x0c,	{0xFF,	0x00,	0x00}}},
//[L6470 DEBUG]:  Caution INT_SPEED is rounded to 615072 [x0.0001 step/s] 
    {{	0x0d,	{0x04,	0x08,	0x00}}},
    {{	0x0e,	{0x19,	0x00,	0x00}}},
    {{	0x0f,	{0x29,	0x00,	0x00}}},
    {{	0x10,	{0x29,	0x00,	0x00}}},
...
//Left justified, MSB first
    ...
    {{REG_MAX_SPEED,     {0x03,   0xFF,   0x00}}}, //0x041
    ...
    {{REG_FS_SPD,        {0x00,   0x08,   0x00}}}, //0x027
